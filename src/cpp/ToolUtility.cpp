...
FILTER_ITEM_TRACK tool_gain(L"Gain", 100.0, 0.0, 1000.0, 0.1, nullptr, 1.0);
...
bool func_proc_audio_utility(FILTER_PROC_AUDIO* audio) {
    ...
    bool do_swap = tool_swap_s.value;
    bool do_inv_l = tool_inv_l_s.value;
    bool do_inv_r = tool_inv_r_s.value;
